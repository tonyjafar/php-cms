        ...
        <div class="row">
            ...
            <div class="col-md-8">
                 <?php
                    if (isset($_GET['cat'])){
                        $id = $_GET['cat'];
                        $countQuery = "select count(*) from posts where post_category_id = '$id' and post_status='public'";
                        $postsQuery = "select * from posts where post_category_id = '$id' and post_status='public' order by post_date DESC";
                        ...
                        if ($count > 0){
                            if ($count > 1){
                                echo "<h1 class='page-header'> The Category has {$count} Posts </h1>";
                            }else{
                                echo "<h1 class='page-header'> The Category has {$count} Post </h1>";
                            }
